...
PREFERRED_FORMATION = {
    (3, 5, 5): kcsapi.Fleet.FORMATION_DOUBLE_LINES,  # TODO: E
    (3, 5, 15): kcsapi.Fleet.FORMATION_SINGLE_LINE,  # K (Boss)
    ...
    (E, 6, 15): kcsapi.Fleet.FORMATION_COMBINED_COMBAT,  # O (Boss)
}
