...
// Be sure to use localhost, not 127.0.0.1, or otherwise you would take 5
// seconds on browsermob-proxy side.
// Seems like a bug.
final DEST = "http://localhost:9090";
...
void handleGet(HttpRequest req) {
  ...
  print("${new DateTime.now()}: ${req.method} ${req.uri.path}");
  addCorsHeaders(res);

  HttpClient client = new HttpClient();
  client.getUrl(Uri.parse(DEST + req.uri.path))
